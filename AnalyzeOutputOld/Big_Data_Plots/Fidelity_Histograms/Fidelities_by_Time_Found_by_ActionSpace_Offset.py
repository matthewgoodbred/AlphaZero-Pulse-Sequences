...
length = 72             # TODO: Change


off_vals = [-1000, -100, -10, -1, 0, 1, 10, 100, 1000]
ylims = [5, 7, 9, 11, 11, 11, 8.2, 6, 4.3]
for val in range(5, 9):
    ...
    path = '/Users/oweneskandari/PycharmProjects/21X/rl_pulse/22S/Thesis_Plots_All/Time_Spent/Offset/'      # TODO
    additional = 'Offset Error = ' + str(off_vals[val])
    plt.colorbar()
    plt.title(name)
    plt.xlabel('Sequence number', fontsize=12)
    plt.ylabel('Reward (offset error = ' + str(off_vals[val]) + ')', fontsize=12)    # TODO
    # plt.xlim(-0.1, 1.1)
