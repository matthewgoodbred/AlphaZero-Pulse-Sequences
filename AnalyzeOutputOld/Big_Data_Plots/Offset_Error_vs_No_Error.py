...
plt.scatter(compx, compy, alpha=0.5, label='Comp')
...
plt.ylabel('Reward (Fractional Offset error)', fontsize=12)    # TODO
plt.xlim(-1, 10.5)
# plt.show()
