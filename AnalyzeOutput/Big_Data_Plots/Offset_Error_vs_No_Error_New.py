...
additional = 'Off Cory SED24 SED48'
...
plt.ylabel('Reward (fractional offset error = 100)', fontsize=12)                  # TODO
plt.xlim(-1, 10.5)
# plt.show()
