...
additional = 'PTE Cory SED24 SED48'
...
plt.ylabel('Reward (fractional phase transient error = 0.01)', fontsize=12)                  # TODO
plt.xlim(-1, 10.5)
# plt.show()
