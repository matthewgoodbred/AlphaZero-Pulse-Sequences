...
for val in range(1, 5):
    ...
    path = '/Users/oweneskandari/PycharmProjects/21X/rl_pulse/22S/Thesis_Plots_All/Time_Spent/PTE/'      # TODO
    additional = 'Phase Transient Error = ' + str(pte_vals[val])
    plt.colorbar()
    plt.title(name)
    plt.xlabel('Sequence number', fontsize=12)
    plt.ylabel('Reward (phase transient error = ' + str(pte_vals[val]) + ')', fontsize=12)    # TODO
    # plt.xlim(-0.1, 1.1)
