...
for val in range(9):
    if val != 4:        # Skip no error
        ...
        for actionspace in ['Original', 'SE', 'SED', 'SEDD']:
            ...
            additional = actionspace + ' Runs Histogram Offset= ' + str(off_vals[val])
            ...
            plt.ylabel('Reward (Fractional Offset Error = ' + str(off_vals[val]) + ')', fontsize=12)    # TODO
            plt.xlim(-0.1, 1.1)
            plt.ylim(-1, 11)
